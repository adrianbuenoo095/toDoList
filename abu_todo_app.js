...
(() => {
    ...
    function addNewItem(event) {
        ...
        let newtodoButton = todoList.insertAdjacentHTML("beforeend", userInputToDO);
        saveToDosToLocalStorage(newtodoButton);
    }
    ...
    function saveToDosToLocalStorage(newTodo) {
        //let toDosListLocalStorage = localStorage.getItem("todos");
        //let todos = toDosListLocalStorage ? JSON.parse(toDosListLocalStorage) : [toDosListLocalStorage];
        todos.push(newTodo);
